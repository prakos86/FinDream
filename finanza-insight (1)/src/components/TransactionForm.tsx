        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-300 rounded-xl py-3 pl-8 pr-12 text-lg font-black text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white"
              autoFocus
            />
            ...
            <button
              ...
              className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg cursor-pointer transition-all ${isListening ? 'bg-indigo-500 text-white animate-pulse' : 'bg-indigo-50 hover:bg-indigo-100 text-indigo-600'}`}
